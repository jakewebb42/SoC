...
void LedBlinkCore::write_blink(int led_num, uint16_t blink_interval_ms) {

    // Write blink interval to the led_timer corresponding to led_pos
   wr_data = blink_interval_ms;
   io_write(base_addr, led_num, wr_data);        
}
